...
form.addEventListener('submit', async(event)=> {
  ...
  if(id){
    url = 'http://localhost:3000/estadocivil/update/';
  }else{
    url = 'http://localhost:3000/estadocivil';
  }
   const data = {  
      id: id ? id : null,
...
async function getData(){
  await fetch(`http://localhost:3000/estadocivil/${id}`) // Replace with your actual backend URL
